...
begin
  ...
  Application.MessageBox('Projeto apagado com sucesso!', 'Informação!', MB_OK + MB_ICONINFORMATION);
end;
...
begin
  //primeiro é preciso fechar o clientDataSet, setar o comando e depois abrir de novo.
  cdsProjetos.Close;
